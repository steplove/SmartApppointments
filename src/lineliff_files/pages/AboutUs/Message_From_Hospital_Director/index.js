...
import image from "assets/images/Smart talk-01.jpg";
...
function Message_From_Hospital_Director() {
            ...
            <Grid>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <a
                    href="/liff/Message_From_Hospital_Director"
                    style={{ color: "#0bb288", fontSize: "1rem" }}
                  >
                    {t("message_from_hospital_director")}
                  </a>
                </Grid>
              </Grid>
...
export default Message_From_Hospital_Director;
